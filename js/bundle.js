...
function cards() {
  //Создаём карточки меню с помощью классов:
  class MenuCard {
  ...
  } //Обращение к серверу и получение данных а нативном JS:
  ...
  }); //Обращение к серверу и получение данных with Axios (библиотека):
...
/* harmony export */   "showModalWindow": function() { return /* binding */ showModalWindow; }
/* harmony export */ });
...
function slider(_ref) {
  ...
  slider.style.position = 'relative'; //создаём точки для слайдера
...
window.addEventListener('DOMContentLoaded', () => {
  const modalTimerId = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_2__.showModalWindow)('.modal', modalTimerId), 15000);
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('.timer', '2022-04-07T23:59:00');
